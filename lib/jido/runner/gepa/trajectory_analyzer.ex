defmodule Jido.Runner.GEPA.TrajectoryAnalyzer do
  @moduledoc """
  ...
  typedstruct module: FailurePoint do
    ...
    field(:category, Jido.Runner.GEPA.TrajectoryAnalyzer.failure_category(), enforce: true)
  ...
  typedstruct module: ReasoningIssue do
    ...
    field(
      :type,
      Jido.Runner.GEPA.TrajectoryAnalyzer.reasoning_issue_type(),
      enforce: true
    )
  ...
  typedstruct module: SuccessIndicator do
    ...
    field(
      :type,
      Jido.Runner.GEPA.TrajectoryAnalyzer.success_indicator_type(),
      enforce: true
    )
  ...
  typedstruct module: ComparativeAnalysis do
    ...
    field(:differences, list(Jido.Runner.GEPA.TrajectoryAnalyzer.Difference.t()), default: [])
  ...
  typedstruct module: TrajectoryAnalysis do
    ...
    field(:failure_points, list(Jido.Runner.GEPA.TrajectoryAnalyzer.FailurePoint.t()),
      default: []
    )

    field(:reasoning_issues, list(Jido.Runner.GEPA.TrajectoryAnalyzer.ReasoningIssue.t()),
      default: []
    )

    field(:success_indicators, list(Jido.Runner.GEPA.TrajectoryAnalyzer.SuccessIndicator.t()),
      default: []
    )
