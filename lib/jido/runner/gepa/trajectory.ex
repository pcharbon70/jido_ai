defmodule Jido.Runner.GEPA.Trajectory do
  @moduledoc """
  ...
  typedstruct module: Step do
    ...
    field(:type, Jido.Runner.GEPA.Trajectory.step_type(), enforce: true)
    field(:content, term(), enforce: true)
    field(:timestamp, DateTime.t(), enforce: true)
    field(:duration_ms, non_neg_integer() | nil)
    field(:metadata, map(), default: %{})
    field(:context, map(), default: %{})
    field(:importance, Jido.Runner.GEPA.Trajectory.importance(), default: :medium)
  ...
  typedstruct do
    ...
    field(:duration_ms, non_neg_integer() | nil)
    field(:metadata, map(), default: %{})
    field(:outcome, Jido.Runner.GEPA.Trajectory.outcome() | nil)
