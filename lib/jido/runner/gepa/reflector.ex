defmodule Jido.Runner.GEPA.Reflector do
  ...
  alias Jido.Runner.GEPA.TrajectoryAnalyzer
  alias Jido.Runner.GEPA.Reflection.{PromptBuilder, SuggestionParser}
  alias Jido.AI.Agent
  ...
  typedstruct module: Suggestion do
    ...
    field(:type, Jido.Runner.GEPA.Reflector.suggestion_type(), enforce: true)
    field(:category, Jido.Runner.GEPA.Reflector.suggestion_category(), enforce: true)
    field(:description, String.t(), enforce: true)
    field(:rationale, String.t(), enforce: true)
    field(:priority, Jido.Runner.GEPA.Reflector.priority(), default: :medium)
  ...
  typedstruct module: ParsedReflection do
    ...
    field(:suggestions, list(Jido.Runner.GEPA.Reflector.Suggestion.t()), default: [])
    field(:expected_improvement, String.t())
    field(:confidence, Jido.Runner.GEPA.Reflector.confidence(), default: :medium)
  ...
  typedstruct module: ConversationState do
    ...
    field(:initial_request, Jido.Runner.GEPA.Reflector.ReflectionRequest.t(), enforce: true)
    field(:turns, list(map()), default: [])
    field(:reflections, list(Jido.Runner.GEPA.Reflector.ParsedReflection.t()), default: [])
