defmodule Jido.Runner.GEPA.SuggestionGeneration do
  ...
  typedstruct module: PromptLocation do
    ...
    field(:type, Jido.Runner.GEPA.SuggestionGeneration.location_type(), enforce: true)
    ...
    field(:scope, Jido.Runner.GEPA.SuggestionGeneration.edit_scope(), default: :phrase)
  ...
  typedstruct module: PromptEdit do
    ...
    field(:operation, Jido.Runner.GEPA.SuggestionGeneration.edit_operation(), enforce: true)
    field(:location, Jido.Runner.GEPA.SuggestionGeneration.PromptLocation.t(), enforce: true)
    field(:content, String.t() | nil)
    field(:target_text, String.t() | nil)

    field(:source_suggestion, Jido.Runner.GEPA.Reflector.Suggestion.t(), enforce: true)
  ...
  typedstruct module: PromptStructure do
    ...
    field(:complexity, Jido.Runner.GEPA.SuggestionGeneration.complexity(), default: :moderate)
  ...
  typedstruct module: EditPlan do
    ...
    field(:prompt_structure,
          Jido.Runner.GEPA.SuggestionGeneration.PromptStructure.t(),
          enforce: true
    )

    field(:edits, list(Jido.Runner.GEPA.SuggestionGeneration.PromptEdit.t()), default: [])
  ...
  typedstruct module: ConflictGroup do
    ...
    field(:edits, list(Jido.Runner.GEPA.SuggestionGeneration.PromptEdit.t()), enforce: true)

    field(:conflict_type,
          Jido.Runner.GEPA.SuggestionGeneration.conflict_type(),
          enforce: true
    )

    field(:resolution_strategy,
          Jido.Runner.GEPA.SuggestionGeneration.resolution_strategy(),
          default: :highest_impact
    )

    field(:resolved, boolean(), default: false)
    field(:selected_edit, Jido.Runner.GEPA.SuggestionGeneration.PromptEdit.t() | nil)
  end
end
