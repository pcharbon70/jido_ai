defmodule Jido.AI.ReqLLM.ProviderMapping do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Jido.AI.ReqLLM.ProviderMapping.get_reqllm_provider(:openai)
      :openai

      iex> Jido.AI.ReqLLM.ProviderMapping.get_reqllm_provider(:anthropic)
      :anthropic
  """
  ...
  model name variations to ensure compatibility with ReqLLM.
  ...
  ## Examples
      ...
      iex> Jido.AI.ReqLLM.ProviderMapping.normalize_model_name("models/gemini-2.0-flash")
      "gemini-2.0-flash"

      iex> Jido.AI.ReqLLM.ProviderMapping.normalize_model_name("gpt-4o")
      "gpt-4o"
  """
  ...
  ## Examples
      ...
      iex> Jido.AI.ReqLLM.ProviderMapping.check_model_deprecation("gpt-4o")
      {:ok, "gpt-4o"}
  ...
  ## Examples
      ...
      iex> Jido.AI.ReqLLM.ProviderMapping.validate_model_availability("openai:gpt-4o")
  ...
  ## Examples
      ...
      iex> Jido.AI.ReqLLM.ProviderMapping.build_reqllm_config(:openai, "gpt-4o")
      {:ok, %{
