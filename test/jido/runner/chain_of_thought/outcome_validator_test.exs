defmodule Jido.Runner.ChainOfThought.OutcomeValidatorTest do
  use ExUnit.Case, async: true

  alias Jido.Runner.ChainOfThought.OutcomeValidator
  alias Jido.Runner.ChainOfThought.OutcomeValidator.ValidationResult
  alias Jido.Runner.ChainOfThought.ReasoningParser.ReasoningStep
