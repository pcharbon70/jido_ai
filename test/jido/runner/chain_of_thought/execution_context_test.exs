defmodule Jido.Runner.ChainOfThought.ExecutionContextTest do
  use ExUnit.Case, async: true

  alias Jido.Runner.ChainOfThought.ExecutionContext
  alias Jido.Runner.ChainOfThought.ExecutionContext.EnrichedContext
  alias Jido.Runner.ChainOfThought.ReasoningParser.{ReasoningPlan, ReasoningStep}
