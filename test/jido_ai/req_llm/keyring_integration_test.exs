defmodule Jido.AI.ReqLLM.KeyringIntegrationTest do
  ...
  describe "get/5 - unified key precedence" do
    ...
    test "returns default when no key found anywhere" do
      ...
      # Mock ReqLLM.Keys to return default
      expect(ReqLLM.Keys, :get, fn :unknown, "default" -> "default" end)
    ...
    test "handles ReqLLM.Keys errors gracefully" do
      ...
      # Mock ReqLLM.Keys to raise an error
      expect(ReqLLM.Keys, :get, fn :openai, "default" ->
  ...
  describe "error handling and edge cases" do
    ...
    test "handles ReqLLM module unavailability" do
      ...
      expect(ReqLLM.Keys, :get, fn _provider, default ->
