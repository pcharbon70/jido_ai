defmodule Jido.AI.ReqLLM.ToolBuilderTest do
  use ExUnit.Case, async: false
  use Mimic

  @moduletag :capture_log

  alias Jido.AI.ReqLLM.{ToolBuilder, ToolExecutor, SchemaValidator}
  ...
  describe "create_tool_descriptor/2" do
    test "successfully creates tool descriptor for valid action", %{test_action: action} do
      # Mock ReqLLM.tool/1 to return a tool descriptor
